...
1. Завантажити та розпакувати дистрибутив ES доступний на сайті розробника. 
2. Після розпакування архіву потрібно запустити bin/elasticsearch.bat.
Після установки і запуску перевіримо працездатність за допомогою запиту:

http://localhost:9200

Ми отримаємо приблизно таку відповідь:
![](../src/images/empl_1.png)
